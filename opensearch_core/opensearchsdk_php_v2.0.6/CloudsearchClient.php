...
class CloudsearchClient
{
    ...
    public function call($path, $params = array(), $method = self::METHOD)
    {
        ...
        if ($this->connect == 'curl' || (defined("SetOpensearchServiceCallHttpProxy") && constant("SetOpensearchServiceCallHttpProxy") !== "")) {
    ...
    private function _curl($url, $params = array(), $method = self::METHOD)
    {
        ...
        if ((defined("SetOpensearchServiceCallHttpProxy") && constant("SetOpensearchServiceCallHttpProxy") !== "")) {
            curl_setopt($session, CURLOPT_PROXY, constant("SetOpensearchServiceCallHttpProxy"));
        }
